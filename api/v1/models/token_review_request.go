...
// TokenReviewRequest TokenReviewRequest is issued by K8s to this service
...
func (m *TokenReviewRequest) validateSpec(formats strfmt.Registry) error {
...
func (m *TokenReviewRequest) validateStatus(formats strfmt.Registry) error {
